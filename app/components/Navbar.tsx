...
const Navbar = () => {
  ...
  return (
    <header className={`bg-white text-black h-[10rem] flex items-center text-[0.95rem] font-radio-canada fixed top-0 left-0 right-0 z-[9999] transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
      ...
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <nav className="hidden md:flex space-x-8 h-[4rem] flex items-center">
          ...
          <div className="relative group">
            ...
            <div className="absolute left-0 hidden w-[18rem] text-[0.90rem] h-[20rem] text-gray-400 py-[3rem] group-hover:block bg-white text-black p-4 rounded shadow-lg">
              <Link href="/collections/braids" className="block px-4 py-2 hover:bg-gray-200">Braids</Link>
              <Link href="/collections/crochets" className="block px-4 py-2 hover:bg-gray-200">Crochets</Link>
              <Link href="/collections/luxury-synthetic-wigs" className="block px-4 py-2 hover:bg-gray-200">Synthetic Wig</Link>
              <Link href="/collections/affordable-luxury-wigs" className="block px-4 py-2 hover:bg-gray-200">Human Hair Blend</Link>
              <Link href="/collections/affordable-luxury-wigs" className="block px-4 py-2 hover:bg-gray-200">Luxury Wigs</Link>
              <Link href="/collections/synthetic-weave" className="block px-4 py-2 hover:bg-gray-200">Synthetic Weave</Link>
            </div>
          </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="relative group">
            <button className="flex">English <svg className="h-3 w-3 mt-[7px] ml-[4px] group-hover:rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" /></svg></button>
        ...
        <nav className="md:hidden bg-white text-black p-4">
          ...
          <div className="relative group">
            ...
            <div className="bg-white text-black p-4 rounded shadow-lg">
              <Link href="/shop/category1" className="block px-4 py-2 hover:bg-gray-200">Category 1</Link>
              <Link href="/shop/category2" className="block px-4 py-2 hover:bg-gray-200">Category 2</Link>
              <Link href="/shop/category3" className="block px-4 py-2 hover:bg-gray-200">Category 3</Link>
            </div>
          </div>
          <Link href="/wholesale" className="block px-4 py-2 hover:bg-gray-200">Wholesale</Link>
