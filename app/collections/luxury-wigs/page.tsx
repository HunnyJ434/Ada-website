...
async function fetchProducts(): Promise<Product[]> {
    ...
    const luxuryWigs = await sanityClient.fetch(query, {}, { 
      tag: `luxury-wigs-${Date.now()}`
    });
    return luxuryWigs;
  }
  
  export default function LuxuryWigs() {
  ...
  return (
    <div className="mt-[16rem] mb-[10rem]  text-[2.7rem]">
        <h1 className="text-center">Luxury Wigs</h1>
